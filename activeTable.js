    ...
    for (var i = 0; i < numHrows; i++) {
        ...
        for (var j = 0; j < numTh; j++) {
            ...
            $(th).mouseleave(function (e) {
                ATpopup.style.visibility = "hidden";
            });
...
function feedback(elem) {
    ...
    div.style.cssText =
        "position: absolute; margin: 0; background-color: rgba(255, 255, 255, 0.0); box-shadow: .05em .05em .5em #00C; " +
        "left: " +
        left +
        "px; top: " +
        top +
...
function thHover(th, e) {
    ...
    $(ATpopup).offset({
        left: parseInt(
            $(th).offset().left + th.clientWidth - ATpopup.clientWidth
        ),
        top: parseInt(
            $(th).offset().top + th.clientHeight / 2 - ATpopup.clientHeight / 2
        ),
    });
}
...
function sortColumn() {
    ...
    TS.curTH = th;
    var bAbc = "undefined" === typeof th.sortabc || !th.sortabc;
    bAbc ? TS.sortAbc() : TS.sortCba();
    th.sortabc = bAbc;
}
...
var gHiddenColumnsKey = "AThiddencolumns";

// add a column to the permanent saved hidden columns
function saveHiddenColumn(colname) {
    var aHidden = {};
    if (localStorage.getItem(gHiddenColumnsKey)) {
        aHidden = JSON.parse(localStorage.getItem(gHiddenColumnsKey));
    }
    aHidden[colname] = true;
    localStorage.setItem(gHiddenColumnsKey, JSON.stringify(aHidden));
}

// return a hash of column names that should be hidden
...
// removed saved hidden columns
function removeHiddenColumns() {
    localStorage.removeItem(gHiddenColumnsKey);
}
...
TS.hideSort = function (event) {
    ...
    if (tsdivup) {
        ...
        while (
            target != relTarget &&
            "sortlink" != relTarget.className &&
            "BODY" != relTarget.nodeName
        ) {
...
TS.showSort = function (th) {
    ...
    if (!tsdivup) {
        ...
        tsdivup.id = "tsdivup";
        tsdivup.innerHTML =
            "<a class='sortlink' title='z-a' style='border: 0; outline: 0; text-decoration: none; color: #00F;' href='#sort z-a' onclick='TS.sortCba(); return false;'>" +
            (TS.bIE ? '<font face="webdings">5</font>' : "&#x25B4;") +
            "</a>";
        ...
        tsdivdn.id = "tsdivdn";
        tsdivdn.innerHTML =
            "<a class='sortlink' title='a-z' style='border: 0; outline: 0; text-decoration: none; color: #00F;' href='#sort a-z' onclick='TS.sortAbc(); return false;'>" +
            (TS.bIE ? '<font face="webdings">6</font>' : "&#x25BE;") +
            "</a>";
...
TS.getText = function (cell, sortType) {
    ...
    var text =
        "undefined" != typeof cell.textContent
            ? cell.textContent
            : "undefined" != typeof cell.innerText
            ? cell.innerText
            : "undefined" != typeof cell.text
            ? cell.text
            : cell.innerHTML;
...
TS.isSortable = function (th) {
    return "tablesort" === th.className || "undefined" != typeof th.tablesort;
};
...
init();
dprint(
    "ActiveTable loaded successfully. Hover over a column header to display the popup to sort or remove a column. Alt+click on any column header to restore all columns."
);
